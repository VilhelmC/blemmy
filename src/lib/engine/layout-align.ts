 ...
 *
 * Called by layout-engine after the iterative slack-absorption pass.
 ...
 *
 * The caller (layout-engine) must ensure:
 *  - The page is NOT in `blemmy-layout-measure-intrinsic` mode.
 *  - All relevant slack CSS variables have already been applied and at least
 *    one `requestAnimationFrame` has settled.
 *
 * @param page     The `.blemmy-page` element for this page
 * @param sidebar  The `#blemmy-sidebar-{1|2}` element
 * @param main     The `#blemmy-main-{1|2}` element
