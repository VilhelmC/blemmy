 ...
 * excluded). Used by `layout-engine` and `LayoutDiagnostics`.
 */

export const CV_SIDEBAR_TAIL_SPACER_CLASS = 'blemmy-sidebar-tail-spacer';
 ...
 * helpers (e.g. `appendChild` on `#blemmy-rebalance-*`) cannot leave the spacer
 * above content.
 */
