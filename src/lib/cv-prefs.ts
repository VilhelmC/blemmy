...
const STORAGE_KEY = 'cv-layout-prefs';
 ...
 */
export const PREFS_CHANGED_EVENT = 'cv-prefs-changed';
 ...
 */
export const ALTERNATIVES_READY_EVENT = 'cv-alternatives-ready';
 ...
 */
export const ALTERNATIVE_SELECTED_EVENT = 'cv-alternative-selected';
